...
const aboutus = () => {
    return (
        <div
            className="bg-black text-white w-full p-10 ">
      <Navbar />
          
            <div className="conttainer text-white rounded-xl p-20  bg-black">
               
                <div className=" mx-auto font-subHeading font-style: normal mb-80 font-bold">
                    <h1 className="subHeading not-italic font-bold text-6xl pt-40 pl-40">
                    Welcome, Jack
                    </h1>
                </div>
            </div>
            ...
            <div className="grid grid-cols-3 md:gap-10 gap-14 md:ml-28 ml-56 mb-20">
                <div className="w-3/4 h-96 overflow-hidden rounded-t-2xl rounded-b-2xl">
                    <div className="bg-baseBlack   p-10">
                        <div className="mb-10">
                            <h1 className="text-4xl font-bold text-center">Values</h1>
            ...
            <div className="h-auto overflow-hidden bg-black text-white ">
                <div className=" mx-auto font-subHeading font-style: normal mb-4 font-bold">
                                <h2 className="subHeading not-italic font-bold text-5xl text-center text-white ">
                                Our Virtue
                        ...
                        <div className="container bg-black mx-auto w-full h-full">
                            <div className="relative wrap overflow-hidden p-10 h-full">
                              ...
                              <div className="mb-8 flex justify-between flex-row-reverse items-center w-full left-timeline">
                                <div className="z-20 flex  mb-96 items-center order-1 bg-black border  w-8 h-4 rounded-full">
                                </div>
                                        <div className="order-1 bg-black rounded-lg shadow-xl w-full  py-4">
                                    ...
                                    <div className="order-1 bg-blue-400 rounded-lg shadow-xl mx-2  px-6 py-4">
                                        ...
                                        <div className="order-1 mt-12 mr-12 transform -rotate-2 h-max bg-baseBlack rounded-lg shadow-xl  px-6 py-4">
                                          <div className="h-80 bg-white rounded-lg shadow-xl  px-6 py-4">
                            
                                            <h3 className="mb-3 w-full font-bold text-black text-xl">Lorem Ipsum</h3>
                                          
                                          </div> 
                                            <p className="mt-10 text-sm font-medium leading-snug tracking-wide text-white text-opacity-100"              >
                                              12th December 2020
                                          </p>
                                          ...
                                          <div className="mb-20 w-full ">
                                              ...
                                              <h3 className="mb-3 w-full text-white font-bold text-4xl">Mozohack</h3>
                                              <p
                                                        className="text-xl leading-relaxed tracking-widest "
                                                      >
                                      ...
                                      <div className="mb-8 flex justify-between items-center w-full right-timeline">
                                        ...
                                        <div className="z-20 mt-10  ml-4 flex items-center order-1 bg-black border  w-4 h-4 rounded-full">
                                        </div>
                                        <div
                                          className="order-1  mb-10 ml-3 bg-gray-400 rounded-lg shadow-xl w-1/2  px-6 py-4"
                                        >
