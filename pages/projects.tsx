    ...
    return (
        ...
        <div>
            ...
            <div className='bg-black pt-28'>
                ...
                <p className='text-white text-center font-light text-xl mt-3 sm:px-auto px-8'>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Natus illo</p>
                ...
                <div className='mt-36'>
                    ...
                    <p className='text-white text-center font-light text-xl mt-3 sm:px-auto px-8'>Projects that we have done for others</p>
                    <div className="flex flex-wrap items-center justify-center sm:mt-20 mt-14 pb-10">
                        {serviceData.map((card) => (
                            <CardProject name={card.title}
                            image={card.image}
                            desc={card.desc} />
                        ))}
