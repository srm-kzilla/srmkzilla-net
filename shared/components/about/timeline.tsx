      ...
      <div className="mb-8 md:flex lg:flex justify-between flex-row-reverse items-center w-full left-timeline">
        ...
        <div className="order-1 bg-black w-full  lg:py-4">
          <div className="order-1 relative w-11/12 md:max-w-full lg:w-4/5 bg-baseBlue rounded-xl -mt-3 lg:mt-0 mx-5 lg:ml-20 px-6 py-3 lg:py-4">
            ...
            <div className="h-6 w-4 absolute bg-baseBlue right-0 transform top-full -mt-3"><div className='w-full h-full relative'><div className='absolute bottom-0 right-0 h-1/2 w-full rounded-tr-full bg-black'></div></div></div>
          </div>
  ...
  return (
    <>
      <div className="mb-8 md:flex lg:flex justify-between  items-center w-full right-timeline">
        <div className="z-30 md:flex lg:flex items-center invisible md:visible lg:visible order-1 bg-white border rounded-full mt-1 md:mt-0 lg:mt-0  lg:ml-0 md:-ml-1 -ml-1 mb-4 md:mb-80 lg:mb-96 w-3 h-3 md:w-8 lg:w-8 md:h-4 lg:h-4"></div>
        <div className="order-1 bg-black w-full">
          <div className="order-1 z-10 w-11/12 md:max-w-full lg:w-4/5 bg-orange600 relative rounded-xl -mt-3 lg:mt-0 mx-4 lg:mx-2 lg:ml-10 px-6 py-3 lg:py-4">
            ...
            <div className="h-6 w-4 absolute bg-orange600 left-0 top-full -mt-3"><div className='w-full h-full relative'><div className='absolute bottom-0 right-0 h-1/2 w-full rounded-tl-full bg-black'></div></div></div>
          </div>
