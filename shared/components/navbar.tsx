        ...
        <div className="md:flex md:items-center md:justify-between">
          ...
          >
            <div className="flex bg-opacity-20 flex-col md:flex-row md:items-center mx-5">
              ...
              <Dropdown
                name="What's New?"
                pos="absolute md:left-80 md:my-12 md:mx-10 md:top-3 py-2 w-48 rounded-md shadow-md py-1 bg-baseBlack cursor-pointer"
                items={["Projects", "Projects", "Youtube", "Projects"]}
                links={["/", "/", "/", "/"]}
                namepos="md:my-2 mx-2 my-2 px-2 py-1 transition duration-500 ease-in-out relative z-10 hover:border-orange300 cursor-pointer border-b-2 border-transparent focus:outline-none"
              />
            </div>
          </div>
          <div className="md:flex-row my-4 md:my-0 origin-top-right hidden md:flex absolute right-5">
            <input
              type="text"
              name="search"
              className={`${
            ...
            <div>
              <Dropdown
                name="En"
                pos="origin-top-right absolute right-1 top-5 my-3 w-48 rounded-md shadow-md py-1 bg-baseBlack cursor-pointer"
                items={["En", "Hn", "Sp"]}
                namepos="flex sm:flex-row focus:outline-none md:my-2"
              />
            </div>
          </div>
        </div>
