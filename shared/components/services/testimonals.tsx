...
const Testimonals = () => {
  return (
    <>
      <div className="container flex flex-col flex-wrap bg-baseBlack rounded-2xl text-white text-xl py-5 my-10">
        <div className="flex flex-col md:flex-row">
          <div className="flex flex-col">
            ...
            <div className="flex place-self-center mb-10 -mt-10 md:mb-0">
              <div className="mr-1">
          ...
          <div>
            <p className="lg:w-4/5 lg:mt-16 p-5">
        ...
        <div className="flex flex-col md:flex-row">
          <div className="flex flex-col">
            ...
            <div className="flex place-self-center mb-10 -mt-10">
