      ...
      <div className="flex flex-col flex-wrap w-full md:flex-row text-white text-xl mx-3 justify-between">
        <div className="xl:w-3/6 lg:w-2/4 w-auto my-5 flex-3 flex-col">
          ...
          <a href="mailto:hello@srmkzilla.net">
            <div className="my-10">
              <button className="flex px-5 py-2 rounded-3xl bg-black-200 border-2 border-white focus:outline-none transition duration-500 ease-in-out  transform hover:-translate-y-1 hover:scale-110">
                <p>Get Started</p>
