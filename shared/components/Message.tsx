...
const Message = (props: { color: String; bubblemsg: String }) => {
  return (
    <div
    ...
    >
      ...
      <motion.div
        ...
        initial="show"
        animate="hidden"
        className="absolute border-white w-full h-full top-0 left-0 rounded-xl border transform -translate-y-1 -translate-x-1 z-10"
      ></motion.div>
      <motion.div
        variants={container}
        initial="show"
