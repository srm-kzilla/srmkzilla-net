...
const Message = (props: { color: String }) => {
    return (
                <div className={`message bg-${props.color} float-right px-6 sm:mr-24 mr-20 py-5 rounded-xl z-10 relative mt-20`}>
                     <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit.</p>
                     <img className='absolute right-0 transform left-full ml-5 sm:top-5 top-2/4' src="./images/messageLogo.png" alt="logo"/>
