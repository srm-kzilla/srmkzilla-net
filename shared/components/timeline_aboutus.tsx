...
export const LeftTimeline = () => {
    return (
        ...
        <div className="mb-8 md:flex lg:flex justify-between flex-row-reverse items-center w-full left-timeline">
          <div className="z-50 md:flex lg:flex block items-center order-1 bg-white border rounded-full mt-1 md:mt-0 lg:mt-0 lg:ml-0 md:ml-4 -ml-1 mb-4 md:mb-80 lg:mb-96 w-3 h-3 md:w-8 lg:w-8 md:h-4 lg:h-4">
            </div>
          <div className="order-1 bg-black w-full  lg:py-4">
            <div className="order-1 min-w-96 bg-baseBlue rounded-xl -mt-3 lg:mt-0 mx-4 lg:mx-10 px-6 py-3 lg:py-4">
              <h3 className=" lg:mb-3 w-full font-bold text-white lg:text-xl">Lorem Ipsum</h3>
            </div>
            <Tilt options={{transition: false}}>
              <div className="Tilt-inner ml-12 min-w-96 transform -rotate-2"> 
                <div className="lg:order-1 mt-6 lg:mt-12 lg:mr-14 lg:transform -rotate-2 max-w-full h-max bg-baseBlack rounded-xl p-4">
          ...
          <div className="lg:mb-20 mt-4 md:-mt-10 lg:mt-0 ml-4 lg:mx-0 w-full ">
            <div className="lg:p-14 w-full ">
              <h3 className="lg:mb-3 w-full text-white font-bold lg:text-3xl">Mozohack</h3>
        ...
        {/* right timeline */}
         <div className="mb-8 md:flex lg:flex justify-between  items-center w-full right-timeline">
          ...
          <div className="order-1 bg-black w-full ">
            <div className="order-1 bg-orange600 rounded-xl ml-12 -mt-3 lg:mt-0 mx-4 px-6 py-3 lg:py-4">
              <h3 className="lg:mb-3 w-full font-bold text-white lg:text-xl">Lorem Ipsum</h3>
            </div>
            <Tilt className="Tilt" options={{ max : 25 }}  >
              <div className="Tilt-inner ml-14"> 
            <div className="order-1 mt-6 lg:mt-12 mr-7 transform rotate-2 max-w-full h-max bg-baseBlack rounded-xl p-4">
