            ...
            <div className="Tilt-inner ml-4 lg:mx-10">
              <div className="lg:order-1 mt-6 lg:mt-12 ml-3 md:ml-0 lg:ml-16 lg:transform -rotate-2 min-w-96 w-11/12 md:max-w-full lg:w-4/5 h-max bg-black-200 rounded-xl p-4">
                <div className="h-64 lg:h-80 bg-white rounded-xl px-3  lg:px-6 lg:py-4">
                  <h3 className="lg:mb-3 w-full font-bold text-black lg:text-xl">
                    Lorem Ipsum
                  </h3>
                </div>
        ...
        <div className="lg:mb-20 mt-4 lg:mt-0 mx-4 pr-5 md:px-0 lg:p-0 md:-mr-2 lg:mx-0 w-full">
          <div className="lg:p-8 w-full ">
            ...
            <p className="lg:text-xl lg:leading-relaxed lg:tracking-widest ">
              A 3-day extravaganza aimed at spreading the message of the power
              of open-source web among the students is complete with workshops,
              technical quizzes, games and much more. Mozofest provides the
              perfect respite to students from their busy schedules.
            </p>
          </div>
        </div>
      </div>
