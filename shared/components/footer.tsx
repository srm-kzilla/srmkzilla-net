    ...
    <div className="relative lg:bg-home-footer bg-home-mobile bg-cover">
      ...
      <div className="relative">
        <div className="absolute flex text-white md:text-2xl text-xl md:top-20 md:bottom-auto top-auto bottom-24 right-1/2 transform translate-x-1/2 md:translate-x-0 md:right-16">
          <Link href='https://www.instagram.com/srmkzilla/'><div className="md:h-12 group h-10 relative md:w-12 w-10 border hover:border-logoGreen border-white rounded-full mr-3">
          ...
          <Link href='https://m.facebook.com/SRMKZILLA/'><div className="md:h-12 group h-10 relative md:w-12 w-10 border hover:border-logoGreen border-white rounded-full mr-3">
          ...
          <Link href='https://twitter.com/SRMKZILLA_Club'><div className="md:h-12 group h-10 relative md:w-12 w-10 border hover:border-logoGreen border-white rounded-full mr-3">
          ...
          <Link href='https://www.linkedin.com/company/srmkzilla/'><div className="md:h-12 group h-10 relative md:w-12 w-10 border hover:border-logoGreen border-white rounded-full mr-3">
