    ...
    return (
        <footer className="container mx-auto text-white rounded-xl mt-5 px-12 py-4 bg-footerBackground">
           ...
           <div className="grid lg:grid-cols-4 gap-4 sm:grid-cols-2">
                <div className="row-span-6 mx-auto">
                    <img className="w-60" src="/images/KZILLA-logo-B-mono-1.png" alt="KZILLA-logo-B-mono-1"/>
            </div>
                <div className="lg:col-span-3 sm:col-span-1 flex justify-end mr-8 mb-4">
                ...
                <div className="row-span-5 text-3xl">
                <ul >
                        Explore
                        <li  className="my-2 text-2xl">
                        <a href="#"><span>Home</span></a>
                        </li>
                        <li className="my-2 text-2xl">Events
