...
const CardProject = (props: { name: String , image:string, desc: String}) => {
  return (
    <motion.div className="bg-baseBlack sm:w-80 w-72 rounded-xl mx-6 p-2 mb-10 shadow-box" whileHover={{scale: 1.05}}>
      ...
      <div className='text-right mr-5 my-5'><button className='bg-black border rounded-full text-white text-xs px-5 py-1 border-white'> Know More </button></div>
    </motion.div>
  );
};
