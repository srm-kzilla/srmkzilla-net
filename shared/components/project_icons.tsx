...
const ProjectIcon = (props: {
  ...
  return (
    <motion.div
      ...
      className="bg-baseBlack h-28 group w-28 sm:mx-16 mx-8 mt-20 rounded-full relative hover:shadow-icon cursor-pointer"
    >
      <img
        src={props.icon}
      ...
      <div className="absolute opacity-0 group-hover:opacity-100 transition-opacity rounded-lg left-3/4 -mt-14">
        {!props.upcomming && (
          <div className="text-white text-lg bg-baseBlack rounded-lg px-3 py-1 relative">
            {props.title}
